...
YAHOOQUERY_FAILURE_COOLDOWN_SECONDS = float(os.getenv("YAHOOQUERY_FAILURE_COOLDOWN_SECONDS", "30"))
YAHOOQUERY_MAX_CONSECUTIVE_EMPTY_BATCHES = int(os.getenv("YAHOOQUERY_MAX_CONSECUTIVE_EMPTY_BATCHES", "2"))
